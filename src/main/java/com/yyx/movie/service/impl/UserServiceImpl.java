...
import com.yyx.movie.mapper.UserMapper;
import com.yyx.movie.model.dto.user.UserQueryRequest;
import com.yyx.movie.model.entity.User;
import com.yyx.movie.model.enums.UserRoleEnum;
import com.yyx.movie.model.vo.LoginUserVO;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements UserService {
    ...
    @Override
    public long userRegister(String userAccount, String userPassword, String checkPassword, String userPhone, Date birthday, String userGender) {
        // 1. 校验
        if (StringUtils.isAnyBlank(userAccount, userPassword, checkPassword, userGender) && birthday != null) {
        ...
        if (userPhone.length() != 11) {
            throw new BusinessException(ErrorCode.PARAMS_ERROR, "手机号出错");
        }
        // 密码和校验密码相同
    ...
    @Override
    public LoginUserVO userLoginWithAccount(String userAccount, String userPassword, HttpServletRequest request) {
        // 1. 校验
